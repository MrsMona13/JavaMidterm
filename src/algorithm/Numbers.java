...
public class Numbers {
    ...
    public static void main(String[] args) throws Exception {
        ...
        connectToSqlDB.insertDataFromArrayToSqlTable("selection_sort",num, "SortingNumbers");
        ...
        System.out.println("Total Execution Time of " + num.length + " numbers in Insertion Sort took: " + insertionSortExecutionTime + " milliseconds");
